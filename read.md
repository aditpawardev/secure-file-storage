Secure File Storage (Django + JavaScript).This project is a secure file storage system built using Django REST Framework for the backend and Vanilla JavaScript for the frontend.
...
Motivation
As a B.Tech Computer Science student, I wanted to build something that goes beyond tutorials and exposes real engineering problems.I was especially interested in learning how APIs handle user authentication, how access to resources is restricted, and how frontend applications securely interact with backend services.
...
This project helped me understand how JWT authentication works in practice.I learned how to secure APIs using permissions and how to protect user-specific resources.
